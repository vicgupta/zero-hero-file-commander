...
type theme struct {
	...
	cursorBg lipgloss.Color // cursor row background; also key-label bg,
	cursorFg lipgloss.Color // dialog-selection bg and dialog-title bg — one
	// accent color used consistently everywhere something is "highlighted"
...
var themes = map[string]theme{
	...
	"nightowl": {
		...
		brightFg: "#ffffff", blackBg: "#011627", dangerBg: "#ef5350",
	},
	...
	"opencode": {
		...
		brightFg: "#ffffff", blackBg: "#000000", dangerBg: "#f44747",
	},
}
...
func applyTheme(name string) {
	...
	styleKeyLabel = lipgloss.NewStyle().Foreground(t.boxFg).Background(t.cursorBg)

	styleDialog = lipgloss.NewStyle().Foreground(t.boxFg).Background(t.boxBg)
	styleDialogSel = lipgloss.NewStyle().Foreground(t.boxFg).Background(t.cursorBg).Bold(true)
	styleTitle = lipgloss.NewStyle().Foreground(t.boxFg).Background(t.cursorBg).Bold(true)
